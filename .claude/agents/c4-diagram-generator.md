...
- The output folder where files should be created (required)
...
**Note**: The output folder will be specified in your task prompt.
...
3. **File Management - YOUR PRIMARY DELIVERABLE**:
   ...
   - Output folder will be specified in task prompt
...
**Note**: The [output-folder] will be provided in your task prompt.
